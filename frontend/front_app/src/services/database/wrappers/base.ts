import { extendRef, reactiveOmit, reactivePick, refWithControl, watchIgnorable, WatchIgnorableReturn } from "@vueuse/core"
import { reactive, ref, shallowReactive, shallowRef, watch } from "vue"
...
export type UseDatabaseDocumentRefOptions<T extends object, A extends readonly string[] = readonly []> = {
    initFn: () => Promise<T>,  /** Колбек инициализации значений из БД (должен вернуть объект документа) */
